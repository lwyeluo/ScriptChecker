...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '0cfd547b465a3611506dc4c4c0ba973ccb2e7f30',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
  'v8_revision': '80bcf1b02bea0370ea82fe471fdf57d76c732944',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'angle_revision': '5ae64c94dbf1766d0c9f233942dcfb38c83229ac',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'pdfium_revision': '6058efdbdc186e120e7e2121c290ac4d820ffbf8',
  # Three lines of non-changing comments so that
...
deps = {
  ...
  'src/ios/third_party/material_components_ios/src': {
      'url': Var('chromium_git') + '/external/github.com/material-components/material-components-ios.git' + '@' + '8c8aad6dc245a6682544952e9d47c44149bffb33',
      'condition': 'checkout_ios',
  },
  ...
  'src/third_party/chromite': {
      'url': Var('chromium_git') + '/chromiumos/chromite.git' + '@' + 'f10b482799b35baabbd3cc54136355d711c9510e',
